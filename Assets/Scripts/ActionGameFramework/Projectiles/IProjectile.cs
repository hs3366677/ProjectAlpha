...
namespace ActionGameFramework.Projectiles
{
	...
	public interface IProjectile
	{
		...
		void FireAtPoint(Vector2 startPoint, Vector2 targetPoint);
		...
		void FireInDirection(Vector2 startPoint, Vector2 fireVector);
		...
		void FireAtVelocity(Vector2 startPoint, Vector2 fireVelocity);
	}
}